...
const MortgageVsRent2025 = () => {
  return (
    <>
      <SEOHead
        title="Ипотека или аренда в 2025: что выгоднее? Полный разбор с расчетами"
        description="🏠 Ипотека vs аренда 2025: детальное сравнение с расчетами, плюсы и минусы, когда что выгоднее. Актуальные ставки, цены, прогнозы экспертов."
        keywords="ипотека или аренда 2025, что выгоднее ипотека или аренда, сравнение ипотеки и аренды, покупка квартиры или аренда, ипотека vs аренда расчет, выгодность ипотеки 2025, стоимость аренды 2025, ипотечные ставки 2025, недвижимость Москва, жилье в кредит или аренда"
        url="/blog/mortgage-vs-rent-2025"
        type="article"
        publishedTime="2025-08-17T00:00:00.000Z"
        modifiedTime="2025-08-17T00:00:00.000Z"
        section="Ипотека"
        tags={["ипотека", "аренда", "недвижимость", "сравнение", "2025", "инвестиции", "жилье"]}
        image="/img/736d7b86-b983-4e00-8341-0087543d3f46.jpg"
        author="Эксперты по недвижимости"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Ипотека или аренда в 2025: что выгоднее? Полный разбор с расчетами",
            "description": "Ипотека vs аренда 2025: детальное сравнение с расчетами, плюсы и минусы, когда что выгоднее. Актуальные ставки, цены, прогнозы экспертов.",
            "image": "https://odobrilicredit.ru/img/736d7b86-b983-4e00-8341-0087543d3f46.jpg",
            "author": {
              "@type": "Organization",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://odobrilicredit.ru/blog/mortgage-vs-rent-2025"
            },
            "articleSection": "Ипотека",
            "keywords": ["ипотека", "аренда", "недвижимость", "сравнение", "2025"],
            "about": [
              {
                "@type": "Thing",
                "name": "Ипотека",
                "description": "Кредит на покупку недвижимости"
              },
              {
                "@type": "Thing", 
                "name": "Аренда жилья",
                "description": "Временное пользование жильем за плату"
              }
            ],
            "mentions": [
              {
                ...
                "description": "Долгосрочный кредит на покупку недвижимости",
                "provider": {
                  "@type": "Organization",
                  "name": "Банки России"
                }
