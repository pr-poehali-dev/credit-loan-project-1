...
const AutoLoanGuide = () => {
  return (
    <>
      <SEOHead
        title="Как взять автокредит и не переплатить — пошаговый гид 2025"
        description="✅ Полный гид по автокредитам 2025: как выбрать банк, получить господдержку, сэкономить на КАСКО и досрочно погасить. 5 этапов + советы экспертов."
        keywords="автокредит 2025, кредит на машину, как взять автокредит выгодно, господдержка автокредит, КАСКО автокредит, досрочное погашение автокредита, автокредит без переплаты, автокредит условия банков, первый автомобиль, семейный автомобиль"
        url="/blog/auto-loan-guide"
        type="article"
        publishedTime="2025-08-17T00:00:00.000Z"
        modifiedTime="2025-08-17T00:00:00.000Z"
        section="Автокредиты"
        tags={["автокредит", "авто", "банки", "кредит", "господдержка", "КАСКО", "досрочное погашение"]}
        image="/img/87dab4fb-7f18-4a04-83bc-0be14b31086c.jpg"
        author="Эксперты по автокредитам"
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Как взять автокредит и не переплатить — пошаговый гид 2025",
            "description": "Полный гид по автокредитам 2025: как выбрать банк, получить господдержку, сэкономить на КАСКО и досрочно погасить. 5 этапов + советы экспертов.",
            "image": "https://odobrilicredit.ru/img/87dab4fb-7f18-4a04-83bc-0be14b31086c.jpg",
            "author": {
              "@type": "Organization",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://odobrilicredit.ru/blog/auto-loan-guide"
            },
            "articleSection": "Автокредиты",
            "keywords": ["автокредит", "кредит на машину", "господдержка", "КАСКО", "досрочное погашение"],
            "about": [
              {
                "@type": "Thing",
                "name": "Автокредит",
              ...
              },
              {
                "@type": "Thing", 
                "name": "Господдержка",
                "description": "Государственные программы поддержки автокредитования"
              }
            ],
            "mentions": [
              {
                ...
                "name": "Автокредит",
                "description": "Целевой кредит на покупку автомобиля",
                "provider": {
                  "@type": "Organization",
                  "name": "Банки России"
                }
